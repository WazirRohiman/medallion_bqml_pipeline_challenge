...
profiling. Gold contains the two required model and prediction scripts, reusable assertions, model
evaluation and inspection, a temporary guardrail fixture, and a read-only cluster profile.
